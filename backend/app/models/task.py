...
class Task(Base):
    ...
    backlog_order = Column(Integer, default=0, nullable=False, index=True)
    ...
    sla_status = Column(String(40), default="on_track", nullable=False, index=True)
    related_knowledge_id = Column(Integer, ForeignKey("knowledge_items.id"), nullable=True, index=True)
